...
player1_mark.addEventListener('click', () => {
    ...
    else if(player2_mark.checked == false && player1_mark.checked == false){
        player1_mark.checked = true;
    }
})
...
play_btn.addEventListener('click', () => {
    ...
    if(player1_name.length >= 1 && player2_name.length >= 1){
        ...
        window.localStorage.setItem('playerInfo', JSON.stringify({player1_name: player1_name, player2_name: player2_name, player1_mark: player1_mark.checked, player2_mark: player2_mark.checked}))
